...
class ChkinoutController extends Controller
{
    ...
    public function actionCreatedartallsay()
    {
        $model = new Report();
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('createdartallsay', [
                'model' => $model,
            ]);
        }
    }

    public function actionCreatedartallsay_1()
    {
        $model = new Report();
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return $this->render('createdartallsay_1', [
                'model' => $model,
            ]);
        }
    }
    ...
    public function actionReportdartallsay(){
        ...
        $pdf = 'reportdartallsay'; //file name
    ...
    public function actionReportdartallsay_1(){
        ...
        $pdf = 'reportdartallsay_1'; //file name
