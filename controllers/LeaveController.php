             ...
             //---------------------------------------------------------------------------------------
                    ...
                    if (isset($model->userid)) {
                        ...
                        foreach ($userid as $x) {
                            ...
                            $sql = "INSERT INTO scan_leave_report (leave_id, userid, depart, leavetype_id, date,date_end,leave_save , commend,commend1,leave_ass,leave_cause)
