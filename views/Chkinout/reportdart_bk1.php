...
foreach ($rwdart as $r) {
    ...
    $content .= "<tr>"
        ...
        ."<td style='font-size: 14px;'  align='center'>".($sumscandate - $sumleave)."</td>"


        ."<td style='font-size: 14px;'  align='center'>".($sumscandate+$count_daydate - $sumleave)."</td>"
...
$content .= "
        ...
        <td style='font-size: 14px;' align='center'> ".$count_daydatepart." </td>

        <td style='font-size: 14px;' align='center'> ".($sumscandate1 - $sumleave)." </td>

        <td style='font-size: 14px;' align='center'><b> ".($count_daydatepart + $sumscandate1 - $sumleave)."</b></td>
