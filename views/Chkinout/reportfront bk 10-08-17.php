...
$content .= "<table width='100%' border='1' style='border-collapse: collapse; border: medium none'>"
    ...
    . "<td style='font-size: 14px;' width='10%' align='center'>เข้าเช้า (03:00-12:00 น.)</td>"
    ...
    . "<td style='font-size: 14px;' width='10%' align='center'>ออกดึก (03:00-10:00 น.)</td>"
...
while (strtotime($strStartDate) <= strtotime($strEndDate)) {
    ...
    $date_new = date("Y-m-d 03:00:00", strtotime($strStartDate));
    ...
    foreach ($rw as $r) {
        ...
        if ($time > '03:00:00' and $time < "12:00:00" and $checktype == '0') {
