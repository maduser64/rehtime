...
foreach ($rwdart as $r) {
    ...
    $sql_leave ="SELECT DISTINCT date
        FROM scan_leave 
        WHERE userid = '$badgenumber'
        AND date BETWEEN '$date_strat' AND '$date_end';";

    $count_leave2 = Yii::$app->db->createCommand($sql_leave)->queryAll();

            //เชควันลา เสาร์ อาทิตย์
            $offnoweek = 0;
        //
            foreach ($count_leave2 as $r) {

                $date_offnoweek = $r['date'];

                $DayOfWeek = date("w", strtotime($date_offnoweek));
    ...
    $sumscandate = $intWorkDay - $sumscandate - $offnoweek;
    ...
    $content .= "<tr>"
        ...
        ."<td style='font-size: 14px;'  align='center'>".$sumscandate. "</td>"
...
$content    = "<table width='100%' border='0'>"
            ...
            . "<tr>"
                ...
                . "จำนวน ". thainumDigit($count_daydateall)." ครั้ง   คิดเป็น ". thainumDigit(SUBSTR($sumpersen,0,5)).' %'
            ...
            . "<tr>"
                ...
                ."</td>"
                . "<td height='24' style='font-size: 22px;' align='left'>
                    จำนวน ". thainumDigit($sumscanleaveall)." ครั้ง   คิดเป็น ". thainumDigit(SUBSTR($sumpersenscan,0,5)).' %'
            ...
            . "<tr>"
                . "<td height='24'  style='font-size: 22px;' align='left'>
                    ไปราชการ/ลากิจ/ลาพักผ่อน/ลาป่วย/OTเสริม "
