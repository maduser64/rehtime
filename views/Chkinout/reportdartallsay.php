...
$content = "<table width='100%'>"
    . "<tr>"
    . "<td width='100%' style='font-size: 14px;' align='center'>  เวลาทำงานปกติ 08:00:00 น. - 16:00:00 น  " . "วันที่  " . DateThai($date_strat) . "  ถึงวันที่  " . DateThai($date_end) . "</td>"
    . "</tr>"
    . "<tr>"
...
$content = "<table width='100%'>"
    . "<tr>"
    . "<td width='100%' style='font-size: 14px;' align='center'> เวลาทำงานปกติ 08:30:00 น. - 16:30:00 น  " . "วันที่  " . DateThai($date_strat) . "  ถึงวันที่  " . DateThai($date_end) . "</td>"
    . "</tr>"
    . "<tr>"
// . "<td width='100%' style='font-size: 14px;' align='center'>" . "วันที่  ".DateThai($date_strat). "  ถึงวันที่  ".DateThai($date_end)."</td>"
    . "</tr>"
...
$sql = "SELECT
        ...
        AND i.intime_id != 4
        AND i.intime_id = 3
        AND SUBSTR(ch.checktime,-8,8) > '08:45:00'
        AND SUBSTR(ch.checktime,-8,8) < '10:00:00'
        AND ch.checktime BETWEEN '$date_new'
        AND '$date_new2'
        GROUP BY
...
foreach ($rwdart as $r) {
    ...
    $content .= "<tr>"
        ...
        . "<td style='font-size: 14px;'  align='left'>" . $name . "</td>"
        . "<td style='font-size: 14px;'  align='left'>" . $deptname . "</td>"
        . "<td style='font-size: 14px;'   align='center'>" . $cout1 . "</td>";

    $coutall1 += $cout1;
}
$content .= "<tr>
        <td style='font-size: 14px;' align='right' colspan='3'><b>รวม </b></td>
        <td style='font-size: 14px;' align='center'>  " . number_format($coutall1, 0) . " </td>
 </tr>";
