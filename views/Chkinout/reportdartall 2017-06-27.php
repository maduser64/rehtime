...
foreach ($rw1 as $r) {
   ...
   $content .="<tr>"
    ...
    $content .="<td style='font-size: 14px;'  align='center'>".$count_daydatepart."</td>"
            . "<td style='font-size: 14px;'  align='center'>".($sumscandate1-$sumleave)."</td>"
...
$content .= "
        ...
        <td style='font-size: 14px;' align='center'><b> ".number_format($count_daydatepartall , 0 )."</b></td>

        <td style='font-size: 14px;'  align='center'>".number_format($sumscandate1all , 0 )."</td>
...
$sumpersen = ($count_daydatepartall / $sumwork ) * 100;

//คำนวณ เปอร์วันทำงาน ไม่แสกนนิ้วมือ
//$sumpersenscan = ($sumwork - $sumscandate1) * 100 / $sumwork;

$sumpersenscan = ($sumscandate1all / $sumwork) * 100;
...
$content    = "<table width='100%' border='0'>"
            ...
            . "<tr>"
                ...
                . "จำนวน ".thainumDigit(number_format($count_daydatepartall , 0 ))." ครั้ง   คิดเป็น ".thainumDigit(SUBSTR($sumpersen , 0,5 ))." %"
            ...
            . "<tr>"
                ...
                ."</td>"
                . "<td height='24' style='font-size: 22px;' align='left'>
                    จำนวน ".thainumDigit(number_format($sumscandate1all , 0 ))." ครั้ง   คิดเป็น ".thainumDigit(SUBSTR($sumpersenscan , 0,5 ))." %"
