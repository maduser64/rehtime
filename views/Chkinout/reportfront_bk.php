...
. "<td style='font-size: 14px;' width='10%' align='center'>เข้าเช้า (07:00-10:00 น.)</td>"
   ...
   // $strStartDate = date ("Y-m-d", strtotime("+1 day", strtotime($strStartDate)));
    ...
    $rw = Yii::$app->db->createCommand($sql)->queryAll();
        ...
        foreach ($rw as $r) {
                ...
                if ($time > '07:00:00' and $time < "10:00:00" and $checktype =='0') {
...
$count_daydatenoscan = count($count_daynoscan);
...
$sumwork = $intTotalDay - $count_daydatenoscan;
...
<td style='font-size: 16px;' align='left' colspan='2'><b>" . "วันทั้งหมด  ".$intTotalDay." วัน
    ...
    ไม่แสกนลายนิ้วมือ ".$sumworkleavel = ($intTotalDay -  $count_daydatenoscan)-($count_leave1 - $count_leave1)- $count_leave1."  ครั้ง 
    </b></td>
