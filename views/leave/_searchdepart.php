...
<div class="leave-search">
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <?php
            $data = \app\models\Userinfo::find()->where(['defaultdepid' => Yii::$app->session["defaultdepid"] ])->all();
        ...
        <div class="col-lg-4">
            ...
            <?= Html::a('<i class="fa fa-save"></i>   บันทึกการลา', ['createdepart'], ['class' => 'btn btn-success']) ?>
        </div>
