...
<div class="leave-form">
    ...
    <?php if($model->leavetype_id == '3') { ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <?php echo $form->field($model, 'leave_position')->textInput(['maxlength' => true,'placeholder' => 'กรอก ตำแหน่ง ...'])->label(false) ?>
    ...
    <?php if($model->leavetype_id == '2') { ?>
        ...
        <div class="row">
            <div class="col-md-6">
                <!-- <input class="form-control" id="leave_cotton2" name="leave_cotton2" type="text" placeholder="กรอก สาเหตุการลา ..."> -->

                    <?php echo  $form->field($model, 'leave_cause')->textInput(['maxlength' => true,'placeholder' => 'กรอก  สาเหตุการลา ...'])->label(false) ?>
            </div>
    ...
    <?php if($model->leavetype_id == '4') { ?>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <?= $form->field($model, 'leave_cause')->textInput(['maxlength' => true,'placeholder' => 'กรอก  สาเหตุการลา ...'])->label(false) ?>
            </div>
